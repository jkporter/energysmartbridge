export const MODE_MAPPING: Record<string, string> = {
    Electric: 'electric',
    Standard: 'electric',
...
export const READABLE_MAPPING: Record<string, string> = {
...
export const DEVICE_CLASS_MAPPING: Record<string, string> = {
    heating: 'heat',
    grid: 'connectivity',
    leak: 'moisture',
